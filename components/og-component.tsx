...
export async function ogComponentJsx({
  fontSize,
  heading,
  mode,
  paint,
  type,
}: OgProps): Promise<JSX.Element> {
  console.log("props", fontSize, heading, mode, paint, type)
  return (
    <div
    ...
    >
      ...
      <div tw="flex items-center w-full justify-between">
        ...
        >
          ...
          <div tw="flex ml-2">{siteConfig.links.githubShort}</div>
        </div>
      </div>
    </div>
  )
